import{s as i,r as l,d as k,e as z,u as S,a as E,j as t,N as B,L as x,H as D}from"./index-9cf2a618.js";import{B as L,d as P,a as H}from"./eventsService-078e2c32.js";import{s as I,S as M,C as W,B as g}from"./Button-64c261b6.js";import{a as T,c as R,f as u}from"./colorizePriorityMarker-374c67c7.js";const C=i.main`
  display: block;
  min-height: 100vh;
...
`,K=i.div`
  ...
  justify-content: start;
  padding: 0 ${e=>e.theme.space[4]}px;
`;function Z(){const[e,f]=l.useState(!1),{eventId:o}=k(),a=z(),{isScreenMobile:r}=S(),d=E(I).find(s=>s.id===o);if(l.useLayoutEffect(()=>{window.scrollTo(0,0)},[a.pathname]),e)return t.jsx(B,{to:"/"});if(d){const{title:s,description:w,date:c,time:m,location:b,category:$,downloadURL:p,priority:h}=d,j=async()=>{const y=await P(o),v=await H(p);y&&v&&f(!0)};return t.jsx(C,{children:t.jsx(M,{children:t.jsxs(W,{children:[t.jsx(x,{to:"/",children:t.jsxs(L,{"aria-label":"Back button",children:[t.jsx(D,{size:16}),"Back"]})}),t.jsx(N,{children:s}),t.jsxs(A,{children:[t.jsx(F,{children:t.jsx(G,{src:p,alt:s})}),t.jsx(U,{children:w}),t.jsxs(q,{children:[t.jsx(n,{children:$}),t.jsx(n,{style:{color:T(h)},children:h}),t.jsx(n,{children:R(b)}),!r&&t.jsxs(n,{children:[u(c)," at ",m]})]}),r&&t.jsx(K,{children:t.jsxs(n,{style:{marginTop:"12px",marginBottom:"40px"},children:[u(c)," at ",m]})}),t.jsxs(J,{children:[t.jsx(x,{to:`/event/${o}/edit`,state:{from:a},children:t.jsx(g,{type:"button",children:"Edit"})}),t.jsx(g,{type:"button",actionHandler:j,children:"Delete event"})]})]})]})})})}else return null}export{Z as default};
