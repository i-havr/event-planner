import{s as Rs,j as Ps,P as ce}from"./index-6a10bcbf.js";const Oc=Rs.section`
  width: 100%;
  min-height: 100%;
...
`,Fc=({children:e})=>Ps.jsx(Lc,{children:e});Fc.propTypes={children:ce.node.isRequired};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kc="storage";function $g(e,t,n){return e=_t(e),_g(e,t,n)}function jg(e){return e=_t(e),yg(e)}function qg(e){return e=_t(e),Eg(e)}function zg(e,t){return e=_t(e),wg(e,t)}function Rg(e=Zo(),t){e=_t(e);const r=Xo(e,kc).getImmediate({identifier:t}),s=qo("storage");return s&&Pg(r,...s),r}function Pg(e,t,n,r={}){Ag(e,t,n,r)}function Cg(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return new Vi(n,r,s,t,Yo)}function Sg(){ze(new me(kc,Cg,"PUBLIC").setMultipleInstances(!0)),Mt(Uo,Bo,""),Mt(Uo,Bo,"esm2017")}Sg();const Vg={apiKey:"AIzaSyCEJzmBGZdpEvEgjmYKG-SRzXzJtAchnQo",authDomain:"event-planner-3df4a.firebaseapp.com",databaseURL:"https://event-planner-3df4a-default-rtdb.europe-west1.firebasedatabase.app",projectId:"event-planner-3df4a",storageBucket:"event-planner-3df4a.appspot.com",messagingSenderId:"403563806083",appId:"1:403563806083:web:12fa6eb05059acfd948ab6",measurementId:"G-8YK0D0SGJY"},Nc=Jo(Vg),Hg=Rg(Nc),Kg=em(Nc),bg=Rs.button`
  display: inline-flex;
  align-items: center;
